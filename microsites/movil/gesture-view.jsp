...
<p style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-stretch: inherit; line-height: 18.2000007629395px; vertical-align: baseline; color: #333333; position: relative;">Esta característica permite visualizar la última fotografía tomada con la <strong>cámara frontal</strong> (selfie) sin necesidad de tocar ningún botón, mediante un gesto.</p>
<p style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-stretch: inherit; line-height: 18.2000007629395px; vertical-align: baseline; color: #333333; position: relative;"> </p>
<p style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-stretch: inherit; line-height: 18.2000007629395px; vertical-align: baseline; color: #333333; position: relative;">Sigue los pasos de esta guía para activar la función y aprender a usarla.</p>
</div>
</div>
</div>
</div>
...
<h3>¿Cómo activar/desactivar Gesture View?</h3>
<div class="mpo-module " data-padding-top="10">
<div class="mpo-type-basic bottom mpo-tb-image">
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<ul>
<li>Gesture View sólo funciona cuando la <strong>cámara frontal</strong> está activa.</li>
<li>Gesture View se encuentra activo por defecto. Para deshabilitarlo, pulsa sobre el icono remarcado en la imagen, desde el menú de la cámara.</li>
</ul>
</div>
</div>
<div class="mpo-media">
...
<div class="span6 mpo-area ">
<h3>¿Cómo funciona Gesture View?</h3>
<div class="mpo-module " data-padding-top="10">
<div class="mpo-type-basic bottom mpo-tb-image">
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>Tras tomar la foto con la cámara frontal, puedes verla simplemente acercando el móvil hacia ti y moviéndolo hacia la horizontal, fíjate en la imagen:</p>
</div>
</div>
<div class="mpo-media">
...
<li><a href="g-flex-2-tono-pantalla-automatico" target="_blank">G Flex 2 Tono pantalla automático</a></li>
</ul>
</div>
</div>
</div>
