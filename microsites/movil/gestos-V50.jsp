					...
					<div class="container">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <p>Además, podrás incluirte en el video mediante la cámara frontal, o mediante una foto de perfil en pantalla</p>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <p>Esta opción nos permite agregar en cada grabación una pequeña foto que se desee mostrar todo el tiempo en el vídeo, o también nos permite, encender la cámara frontal para poder vernos reflejados en la grabación.</p>
                                    </li>
                                    <li>
                                        <p>Fuente de Audio </p>
                                        <p> Nos permite seleccionar si el audio a grabar es del micrófono del equipo o si grabe el audio de lo que se muestra en la pantalla (audio de algún video que se esté reproduciendo en el móvil, alguna canción que se reproduce.) </p>
                                    </li>
                        ...
                        <div class="row">
                            <div class="col">
                                <p>
                                    ...
                                    Doble, a la pantalla del móvil. Y para pasar la vista de la app, de la Pantalla del
                                    móvil a la Pantalla Doble, se deberá deslizar de Derecha a Izquierda.
                                </p>
                                <img src="/es/mp-resources/images/posventa/microsites/movil/gestos-V50/1.jpg" class="img-fluid w-100 mx-auto d-block" alt="...">

                                <ul>
                                    <li> Dependiendo de la pantalla de la app, podría variar al ser movida. </li>
                                    <li>Si desea ver la pantalla de visualización tal como está, toque y mueva la
                                        pantalla con precisión con tres dedos </li>
                                    <li>Válido para LG G8X, LG V50, LG V60 y LG Velvet
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                <ul>
                                    <li>
                                        ...
                                        sobre que se muestran en la imagen 1. (Se debe tener activo la rotación de
                                        pantalla)
                                    </li>
                                    <li>Para dejar de utilizar la Pantalla Doble como teclado, presionar el icono de
                                        pantalla doble que se muestra en la imagen a continuación, o coloque el terminal
