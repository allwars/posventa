											...
											<div class="mpo-desc-grp" mode="preview">
												<div class="mpo-desc">
													...
													<p>Gracias a este modo, puedes comprobar si <strong>alguna
															aplicación es la</strong> <strong>causa de
															problemas</strong> en el dispositivo como: reinicios, fallos
														en aplicaciones o un consumo elevado de batería.</p>
													<p> </p>
													<p>Reinicia tu terminal en modo seguro y úsalo durante un tiempo, si
														ves que el problema se ha solucionado, alguna de las
														aplicaciones instaladas es la causa del mismo. Desinstala una a
														una hasta localizar la aplicación que está causando problemas en tu terminal.</p>
													<p> </p>
													<p> </p>
													<p><strong>¿Cómo reiniciar en modo seguro?</strong></p>
													<p> </p>
													<p>Dependiendo de la versión de tu sistema operativo Android el
														método para reiniciar en modo seguro cambia. Seguidamente te
								...
								<div class="span4 mpo-area ">
									<div class="mpo-module " data-padding-top="10">
										<div class="mpo-type-basic mpo-tb-nomedia">
											<div class="mpo-desc-grp" mode="preview">
												<div class="mpo-desc">
													<p>1. Presiona el botón de <strong>Encendido</strong> hasta que
														aparezca la pantalla de apagar o reiniciar el teléfono.</p>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="span4 mpo-area ">
									<div class="mpo-module " data-padding-top="10">
										<div class="mpo-type-basic mpo-tb-nomedia">
											<div class="mpo-desc-grp" mode="preview">
												<div class="mpo-desc">
													<p>2. Pulsa y mantén el dedo sobre la opción
														de <strong>Apagar</strong>. Aparecerá el siguiente mensaje y a continuación presionamos sobre "<strong>Reiniciar</strong>".</p>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="span4 mpo-area ">
									<div class="mpo-module " data-padding-top="10">
										<div class="mpo-type-basic mpo-tb-nomedia">
											<div class="mpo-desc-grp" mode="preview">
												<div class="mpo-desc">
													<p>3. Por último, el teléfono se reiniciará y aparecerá abajo a la izquierda de
								...
								<div class="span4 mpo-area ">
									<div class="mpo-module " data-padding-top="10">
										<div class="mpo-type-basic mpo-tb-nomedia">
											<div class="mpo-desc-grp" mode="preview">
												<div class="mpo-desc">
													<p>1. Apaga el teléfono. Una vez apagado, presiona y mantén apretado
														el <strong>botón de encendido</strong>.</p>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="span4 mpo-area ">
									<div class="mpo-module " data-padding-top="10">
										<div class="mpo-type-basic mpo-tb-nomedia">
											<div class="mpo-desc-grp" mode="preview">
												<div class="mpo-desc">
													<p>2. Cuando aparezca el logo de LG, suelta el botón de encendido y
														pulsa y mantén presionado el botón de <strong>bajar volumen</strong>.</p>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="span4 mpo-area ">
									<div class="mpo-module " data-padding-top="10">
										<div class="mpo-type-basic mpo-tb-nomedia">
											<div class="mpo-desc-grp" mode="preview">
												<div class="mpo-desc">
													<p>3. Verás que abajo a la izquierda de la pantalla aparece el
