...
<div class="mpo-desc">
<p><strong>Incidencia detectada</strong>: en aquellos equipos con la función <a href="../../guias-y-soluciones/television/webos-3-desconectar-servicios-hbbtv" target="_parent">HBBTV</a> activada, la pantalla muestra un color verde y aparece un mensaje advirtiendo que una aplicación se reiniciará para liberar más memoria.</p>
<p> </p>
<p><strong>Causa</strong>: una incidencia producida por una emisión incorrecta.</p>
<p> </p>
<p><strong>Solución</strong>:</p>
<p> </p>
<p>PASO 1: desconecta el cable de antena del equipo durante 5 minutos o hasta que aparezcan la imagen o mensaje de SIN SEÑAL.</p>
...
<p> </p>
<p>PASO 3: actualiza el software del equipo, puedes <a href="actualizar-software-webos" target="_parent">consultar esta página</a>.</p>
</div>
</div>
</div>
</div>
