...
<div class="mpo-desc">
<p>En esta guía te mostramos paso a paso cómo ordenar los canales de tu televisor con sistema operativo <a href="http://www.lg.com/es/webos" target="_blank">webOS</a> 2.0 (modelos 2015).</p>
</div>
</div>
</div>
</div>
...
<p> </p>
<p style="padding-left: 30px;">a) Seleccionar un canal y <strong>editar</strong> su número: por ejemplo, seleccionamos el canal de la posición 1 y lo cambiamos a la posición 3. Si no dispones de este método, actualiza tu televisor siguiendo <a href="http://www.lg.com/es/posventa/actualizar-sw/smarttv" target="_blank">esta guía</a>.</p>
<p> </p>
<p style="padding-left: 30px;">b) Seleccionar uno o varios canales y <strong>moverlos</strong> a partir de una posición: por ejemplo, seleccionamos el canal de la posición 5 y lo movemos a la posición 2. Esto hará que el canal antiguo de la posición 2 y los siguientes se muevan más abajo para hacer sitio a los que hemos insertado.</p>
</div>
</div>
</div>
</div>
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p><span class="mpo-lgred"><strong>NOTA</strong></span>: si detectas que en la lista de canales falta alguna posición (por ejemplo la 3 o la 7) lee <a href="webos-2-canal-oculto" target="_blank">esta guía</a>. Algunas versiones antiguas tenían dificultades con un canal oculto llamado ingeniería y alguna posición desaparecía de la lista.</p>
</div>
</div>
</div>
</div>
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>1. Si tu mando es el <strong>Magic Control</strong>, aprieta la tecla de <strong>Ajustes</strong>. Si es el mando estándar, aprieta la tecla <strong>Settings</strong>.</p>
</div>
</div>
<div class="mpo-media">
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>3. En el menú lateral <strong>Canales</strong>, selecciona la opción <strong>Administrador de canales</strong>.</p>
</div>
</div>
<div class="mpo-media">
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>1. Pulsa en el botón de arriba a la derecha, <strong>Editar Números de Canales.</strong></p>
</div>
</div>
<div class="mpo-media">
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>2. En la lista de la izquierda, selecciona un canal con el botón <strong>OK</strong>. En nuestro ejemplo, el canal de la posición 73.</p>
</div>
</div>
<div class="mpo-media">
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>3. En la lista de la derecha, selecciona la posición <strong>destino</strong>. En nuestro ejemplo, la 2. El resto de la lista no sufrirá cambios.</p>
</div>
</div>
<div class="mpo-media">
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>4. Pulsamos el <strong>botón central entre las 2 listas.</strong></p>
</div>
</div>
<div class="mpo-media">
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>5. Ya tenemos el canal en la nueva posición.</p>
</div>
</div>
<div class="mpo-media">
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>1. Pulsa en el botón de arriba a la derecha, <strong>Mover</strong>.</p>
</div>
</div>
<div class="mpo-media">
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>2. En la lista de la izquierda, selecciona el <strong>canal que deseas mover</strong>. También puedes seleccionar varios, para moverlos todos al mismo tiempo. En nuestro ejemplo movemos el canal de la posición 3.</p>
</div>
</div>
<div class="mpo-media">
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>3. En la lista derecha, selecciona el <strong>canal de destino</strong>. En nuestro ejemplo, movemos el canal 3 a la posición 5. Si has seleccionado varios, todos ellos se colocarán a partir de la posición 5. Los canales que había antes se moverán detrás.</p>
</div>
</div>
<div class="mpo-media">
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>4. Ahora pulsa en el <strong>botón central entre las 2 listas</strong>.</p>
</div>
</div>
<div class="mpo-media">
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>5. Selecciona <strong>Mover</strong> para confirmar la operación.</p>
</div>
</div>
<div class="mpo-media">
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>6. Ya tenemos el canal o canales en la nueva posición.</p>
</div>
</div>
<div class="mpo-media">
...
<li><a href="resetear-password" target="_parent">Contraseña TV olvidada</a></li>
</ul>
</div>
</div>
</div>
