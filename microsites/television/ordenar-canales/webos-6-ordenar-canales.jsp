					...
					<div class="row mpo-header">
						<div class="span12">
							...
							<div class="share" id="shareClick" style="margin-right:10px;">
								...
								<!-- LGEES-2535 -->
								<div class="shareload"
									data-url="/es/lgcompf4/support/share/snsList.lg?systemFlag=CS&amp;longUrl=http://www.lg.com/es/posventa/guias-y-soluciones/television/webos-6-ordenar-canales&amp;imageUrl=http://www.lg.com/es/mp-common/images/common/lg-logo-fb.png&amp;micrositeFlag=Y">
								</div>
								<!-- LGEES-2535 END -->
							</div>
						</div>
						...
						<div class="mpo-fix-navi">
							<ul>
								<li class="current" style="width:158px"> <a class="current"
										href="webos-6-ordenar-canales" target="_parent">WebOS 3.0 a 4.5</a></li>
						...
						<div class="mpo-desc-grp collapse-so  webos" id="webos">
							<div class="card card-body mpo-desc mpo-fix-navi">
								<ul style="flex-wrap: wrap;">
									<li style="margin-left: 1rem;"> <a class="current" href="webos-6-ordenar-canales"
											target="_parent">WebOS 6</a></li>
									<li style="margin-left: 1rem;"> <a href="webos-5-ordenar-canales"
											target="_parent">WebOS 5</a></li>
									<li style="margin-left: 1rem;"> <a href="webos-3-ordenar-canales"
							...
							<div class=" card card-body mpo-desc mpo-fix-navi">
								<ul>
									<li class="current"> <a href="webos-3-ordenar-canales"
											target="_parent">LH570/LJ500</a></li>
									<li> <a href="webos-2-ordenar-canales" target="_parent">LH500</a></li>
								</ul>
							</div>
						</div>
								...
								<div class="span6 mpo-area row ">
									<div class="mpo-module " data-padding-top="10">
										<div class="mpo-type-basic bottom mpo-tb-image">
											<div class="mpo-desc-grp" mode="preview">
												<div class="mpo-desc">
													<p>2. Aparecerá una barra de iconos en el lateral izquierdo,
														selecciona el penúltimo icono, con el dibujo de tres puntos
														verticales para acceder a <strong>Toda la
											...
											<div class="mpo-media">
												<span class="loader"><img
														...
														src="/es/mp-resources/images/posventa/guias-y-soluciones/television/webos-6-ordenar-canales/1.jpg" /></span>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="span6 mpo-area row ">
									<div class="mpo-module " data-padding-top="10">
										<div class="mpo-type-basic bottom mpo-tb-image">
											<div class="mpo-desc-grp" mode="preview">
												<div class="mpo-desc">
													<p>3. Accede al menú <strong>Generales</strong>,
														y dentro de este dirígete al menú <strong>canales</strong>.</p>
												</div>
											</div>
											<div class="mpo-media">
												<span class="loader"><img alt="lg-webos-3-menu-administrador-canales"
														src="/es/mp-resources/images/posventa/guias-y-soluciones/television/webos-6-ordenar-canales/2.jpg" /></span>
											</div>
										</div>
									</div>
								</div>
								<div class="span6 mpo-area  row">
									<div class="mpo-module " data-padding-top="10">
										<div class="mpo-type-basic bottom mpo-tb-image">
											<div class="mpo-desc-grp" mode="preview">
												<div class="mpo-desc">
													<p>4. <strong>Canales</strong>,
														selecciona la opción <strong>Administrador de canales</strong>.
													</p>
												</div>
											</div>
											<div class="mpo-media">
												<span class="loader"><img alt="lg-ordenar-canales-webos-6.0-1"
														src="/es/mp-resources/images/posventa/guias-y-soluciones/television/webos-6-ordenar-canales/3.jpg" /></span>
											</div>
										</div>
									</div>
								</div>
								<div class="span6 mpo-area  row">
									<div class="mpo-module " data-padding-top="10">
										<div class="mpo-type-basic bottom mpo-tb-image">
											<div class="mpo-desc-grp" mode="preview">
												<div class="mpo-desc">
													<p>5. Selecciona <strong>Editar Todos los Programas</strong>.</p>
												</div>
											</div>
											<div class="mpo-media">
												<span class="loader"><img alt="lg-ordenar-canales-webos-6.0-1"
														src="/es/mp-resources/images/posventa/guias-y-soluciones/television/webos-6-ordenar-canales/4.jpg" /></span>
											</div>
										</div>
									</div>
								</div>
								<div class="span6 mpo-area  row">
									<div class="mpo-module " data-padding-top="10">
										<div class="mpo-type-basic bottom mpo-tb-image">
											<div class="mpo-desc-grp" mode="preview">
												<div class="mpo-desc">
													<p>6. Desde la ventana de <strong>Editor Todos los
															Programas</strong> podrás <strong>Mover,
															Bloquear/Desbloquear</strong> o <strong>Editar el Número de
															Canal</strong> con la ayuda de
														los botones de colores del mando a distancia.</p>
												</div>
											</div>
											<div class="mpo-media">
												<span class="loader"><img alt="lg-ordenar-canales-webos-6.0-1"
														src="/es/mp-resources/images/posventa/guias-y-soluciones/television/webos-6-ordenar-canales/5.jpg" /></span>
											</div>
										</div>
									</div>
								</div>
												...
												<div class="span6 mpo-area row">
													<div class="mpo-module " data-padding-top="10">
														<div class="mpo-type-basic bottom mpo-tb-image">
															...
															<div class="mpo-media">
																<span class="loader"><img
																		alt="lg-ordenar-canales-webos-6.0-3"
																		src="/es/mp-resources/images/posventa/guias-y-soluciones/television/webos-6-ordenar-canales/8.jpg" /></span>
															</div>
															<div class="mpo-desc-grp" mode="preview">
																<div class="mpo-desc">
																	<p>Pulsa el botón <strong>AZUL</strong> del
																		mando a distancia
												...
												<div class="span6 mpo-area row">
													<div class="mpo-module " data-padding-top="10">
														<div class="mpo-type-basic bottom mpo-tb-image">
															<div class="mpo-desc-grp" mode="preview">
																<div class="mpo-desc">
																	<p>2. Aparecerá la ventana de edición para
																		ingresar la nueva
																		posición. </p>
																</div>
															</div>
															<div class="mpo-media">
																<span class="loader"><img
																		alt="lg-ordenar-canales-webos-6.0-5"
																		src="/es/mp-resources/images/posventa/guias-y-soluciones/television/webos-6-ordenar-canales/6.jpg" /></span>
															</div>
														</div>
													</div>
												</div>
												<div class="span6 mpo-area row">
													<div class="mpo-module " data-padding-top="10">
														<div class="mpo-type-basic bottom mpo-tb-image">
															<div class="mpo-desc-grp" mode="preview">
																<div class="mpo-desc">
																	<p>3. En nuestro ejemplo seleccionamos 1 y hacemos
																		clic encima del botón <strong>Enviar</strong>.
																	</p>
																</div>
															</div>
															<div class="mpo-media">
																<span class="loader"><img
																		alt="lg-ordenar-canales-webos-6.0-6"
																		src="/es/mp-resources/images/posventa/guias-y-soluciones/television/webos-6-ordenar-canales/7.jpg" /></span>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="span6 mpo-area row">
													<div class="mpo-module " data-padding-top="10">
														<div class="mpo-type-basic bottom mpo-tb-image">
															<div class="mpo-desc-grp" mode="preview">
																<div class="mpo-desc">
																	<p>4. Ya tenemos el canal en la nueva
															...
															<div class="mpo-media">
																<span class="loader"><img
																		alt="lg-ordenar-canales-webos-6.0-7"
																		src="/es/mp-resources/images/posventa/guias-y-soluciones/television/webos-6-ordenar-canales/8.jpg" /></span>
															</div>
														</div>
													</div>
												...
												<div class="span6 mpo-area row">
													<div class="mpo-module " data-padding-top="10">
														<div class="mpo-type-basic bottom mpo-tb-image">
															<div class="mpo-desc-grp" mode="preview">
																<div class="mpo-desc">
																	<p>1. Selecciona pulsando el botón OK un conjunto de
																		canales. En este ejemplo, seleccionamos los
																		canales de las posiciones 12 y 15.</p>
																</div>
															</div>
															<div class="mpo-media">
																<span class="loader"><img
																		alt="lg-ordenar-canales-webos-6.0-moviendo-1"
																		src="/es/mp-resources/images/posventa/guias-y-soluciones/television/webos-6-ordenar-canales/9.jpg" /></span>
															</div>
														</div>
													</div>
												</div>
												<div class="span6 mpo-area row">
													<div class="mpo-module " data-padding-top="10">
														<div class="mpo-type-basic bottom mpo-tb-image">
															...
															<div class="mpo-media">
																<span class="loader"><img
																		alt="lg-ordenar-canales-webos-6.0-moviendo-2"
																		src="/es/mp-resources/images/posventa/guias-y-soluciones/television/webos-6-ordenar-canales/10.jpg" /></span>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="span6 mpo-area row">
													<div class="mpo-module " data-padding-top="10">
														<div class="mpo-type-basic bottom mpo-tb-image">
															...
															<div class="mpo-media">
																<span class="loader"><img
																		alt="lg-ordenar-canales-webos-6.0-moviendo-3"
																		src="/es/mp-resources/images/posventa/guias-y-soluciones/television/webos-6-ordenar-canales/11.jpg" /></span>
															</div>
														</div>
													</div>
												</div>
															...
															<div class="mpo-desc-grp" mode="preview">
																<div class="mpo-desc">
																	<p>4. Los canales se han movido. Puedes ver en
																		nuestro ejemplo como los canales seleccionados
																		están ahora en las posiciones 1 y 2.</p>
																</div>
															</div>
															<div class="mpo-media">
																<span class="loader"><img
																		alt="lg-ordenar-canales-webos-6.0-moviendo-4"
																		src="/es/mp-resources/images/posventa/guias-y-soluciones/television/webos-6-ordenar-canales/12.jpg" /></span>
															</div>
														</div>
													</div>
												</div>
											...
											<div class="mpo-desc">
												<ul class="row-wrap">
													...
													<li><a href="../../microsites/television/crear-filtros-canales-satelite"
															...
															favoritos</a></li>
													<li><a href="sintonizar-canales-webos-3" target="_parent">Sintonizar
															canales
															con webOS</a></li>
