...
<h1>LG Photo Editor</h1>
</div>
<div class="share" id="shareClick" style="margin-right:10px;">
<!-- LGEES-2638 START-->
<!-- LGEES-2638 END-->
<!-- LGEES-2535 -->
<div class="shareload" data-url="/es/lgcompf4/support/share/snsList.lg?systemFlag=CS&amp;longUrl=http://www.lg.com/es/posventa/microsites/television/webos-lg-photo-editor&amp;imageUrl=http://www.lg.com/es/mp-common/images/common/lg-logo-fb.png&amp;micrositeFlag=Y"></div>
<!-- LGEES-2535 END -->
</div>
</div>
</div>
...
<div class="mpo-desc">
<p>Editar imágenes y <a href="hacer-capturas-pantalla-webos" target="_parent">capturas de pantalla</a> es muy sencillo con nuestras <strong>LG SmartTV</strong> con sistema <a href="http://www.lg.com/es/webos" target="_parent">webOS</a>. De serie incluyen la aplicación <strong>LG Photo Editor</strong>, un completo editor de fotos con multitud de opciones. Además, también te permitirá guardar tus imágenes en uno de los dispositivos USB conectados (pendrive o disco duro).</p>
<p> </p>
<p>En esta guía te mostramos cómo utilizar esta aplicación paso a paso.</p>
<p> </p>
<p><span class="mpo-lgred"><strong>NOTA</strong></span>: LG Photo Editor requiere para funcionar el mando a distancia <a href="mando-magic-control-an-mr600-webos-2015" target="_parent">Magic Control</a>, ya que con el mando tradicional no podrían utilizarse muchas de sus funciones.</p>
</div>
</div>
</div>
</div>
...
<span class="loader"><img alt="" src="/es/mp-resources/images/posventa/microsites/television/webos-lg-photo-editor/LG-webos-2-photo-editor_9999.jpg"/></span>
</div>
</div>
</div>
</div>
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>1. Accede al <a href="webos-barra-acceso-rapido-lanzador-launcher" target="_blank">launcher de webOS</a> e inicia la aplicación.</p>
<p> </p>
<p> </p>
<p> </p>
</div>
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>3. Fíjate en la barra inferior de LG Photo Editor. Aquí tienes todas las opciones de la aplicación. Vamos a pulsar en <strong>Galería</strong> para acceder a las imágenes y capturas de pantalla guardadas.</p>
<p> </p>
</div>
</div>
<div class="mpo-media">
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>4. Además de ver las capturas guardadas en el TV, también puedes hacer fotos si dispones de la cámara opcional y ver las imágenes almacenadas en los dispositivos USB conectados. Pulsa por ejemplo en <strong>Imagen capturada</strong>.</p>
</div>
</div>
<div class="mpo-media">
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>8. Cuando termines la edición, pulsa en el botón de <strong>Guardar</strong>. Fíjate en las opciones. Podrás guardar la captura en la memoria interna o en un dispositivo USB conectado al TV.</p>
</div>
</div>
<div class="mpo-media">
