...
<head>
  ...
  >
    <c:param
      name="title"
      value="Activar y desactivar el modo tienda en el televisor"
    />
      ...
      <div class="wrapper">
        ...
        <div class="fluid container" id="content">
          <div class="row mpo-header">
            <div class="span12">
              <div class="mpo-header-h1">
                <h1 class="hasGroup">
                  Activar y desactivar el modo tienda en el televisor
                </h1>
              </div>
          ...
          <div class="content">
            <div class="text">
              <p>
                Los televisores LG poseen una configuración enfocada a la
                exposición en tiendas (Modo Tienda/Modo Demo) con
                funcionalidades específicas tales como reproducción en bucle de
                contenidos, configuración especifica de la imagen etc.
              </p>
            </div>
            <div class="text">
              <p>
                Este tipo de funcionalidades pueden no ser las óptimas para el
                uso del equipo en un hogar particular por lo que desde LG
                Electronics recomendamos el uso de los equipos en Modo “Uso en
                Casa” para asegurarse si su televisor está correctamente
                configurado compruébelo en el siguiente apartado del Menú de
                ajustes.
              </p>
            </div>
            <div class="tittle-img">
              <h3>WebOS 2022</h3>
              <img loading="lazy"
                src="/es/mp-resources/images/posventa/microsites/television/activar-y-desactivar-el-modo-tienda-en-el-televisor/1.jpg"
                alt=""
              />
            </div>
            <div class="tittle-img">
              <h3>WebOS 6.0</h3>
              <img loading="lazy"
                src="/es/mp-resources/images/posventa/microsites/television/activar-y-desactivar-el-modo-tienda-en-el-televisor/2.jpg"
                alt=""
              />
            </div>
            <div class="tittle-img">
              <h3>WebOS 5.0</h3>
              <img loading="lazy"
                src="/es/mp-resources/images/posventa/microsites/television/activar-y-desactivar-el-modo-tienda-en-el-televisor/3.jpg"
                alt=""
              />
            </div>
            <div class="tittle-img two-columns">
              ...
              <img loading="lazy"
                src="/es/mp-resources/images/posventa/microsites/television/activar-y-desactivar-el-modo-tienda-en-el-televisor/4.jpg"
                alt=""
              />
              <img loading="lazy"
                src="/es/mp-resources/images/posventa/microsites/television/activar-y-desactivar-el-modo-tienda-en-el-televisor/5.jpg"
                alt=""
              />
              <img loading="lazy"
                src="/es/mp-resources/images/posventa/microsites/television/activar-y-desactivar-el-modo-tienda-en-el-televisor/6.jpg"
                alt=""
              />
              <img loading="lazy"
                src="/es/mp-resources/images/posventa/microsites/television/activar-y-desactivar-el-modo-tienda-en-el-televisor/7.jpg"
                alt=""
              />
              <img loading="lazy"
                src="/es/mp-resources/images/posventa/microsites/television/activar-y-desactivar-el-modo-tienda-en-el-televisor/8.jpg"
                alt=""
              />
              <img loading="lazy"
                src="/es/mp-resources/images/posventa/microsites/television/activar-y-desactivar-el-modo-tienda-en-el-televisor/9.jpg"
                alt=""
              />
              <img loading="lazy"
                src="/es/mp-resources/images/posventa/microsites/television/activar-y-desactivar-el-modo-tienda-en-el-televisor/10.jpg"
                alt=""
              />
            </div>
          </div>
