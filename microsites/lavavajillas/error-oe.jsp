									...
									<div class="mpo-module " data-padding-top="10">
										<div class="mpo-type-basic mpo-tb-nomedia">
											<div class="mpo-desc-grp d-flex flex-column" mode="preview">
												...
												<div class="mpo-desc">
													<ul>
														<li>- Comprobar que el equipo no esté desnivelado. </li>
													</ul>
													<p> </p>
													...
													<p> </p>
													<ul>
														<li>El tubo de desagüe está doblado o atascado. El agua del
															electrodoméstico no se desagua o lo hace lentamente. </li>
														<li>Revise su propia instalación;
															<ul>
																<li style="list-style-type: circle;background: none;"> Es posible que la tubería esté obstruida. Para ello,
																	vierta 2 litros de agua por la tubería para ver si
																	es capaz de desaguarlos correctamente. </li>
																	<li style="list-style-type: circle;background: none;"> Si hay varios equipos conectados al mismo desagüe,
