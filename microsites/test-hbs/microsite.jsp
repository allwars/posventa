	...
	<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
		<%@ include file="/WEB-INF/jsp/gpCommon/includes/doctype.jsp" %>
			<%@ include file="/WEB-INF/jsp/gpCommon/includes/pageTop.jsp" %>
				...
				<script defer="defer" src="js/bundle.js"></script><link href="css/main-styles.css" rel="stylesheet"></head>
					...
					<div class="container-fluid">
						...
						<div class="support-wrap">
							...
							<div class="share" id="shareClick" style="margin-right:10px;">
								...
								<div class="shareload" data-url="/es/lgcompf4/support/share/snsList.lg?systemFlag=CS&amp;longUrl=http://www.lg.com/es/posventa/microsites/lavado-secado/mantenimiento-secadora&amp;imageUrl=http://www.lg.com/es/mp-common/images/common/lg-logo-fb.png&amp;micrositeFlag=Y">
								</div>
