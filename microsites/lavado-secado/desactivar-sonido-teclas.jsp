          ...
          <div class="row mpo-header">
            <div class="span12">
              ...
              <div class="share" id="shareClick" style="margin-right: 10px">
                ...
                <div
                  class="shareload"
                  data-url="/es/lgcompf4/support/share/snsList.lg?systemFlag=CS&amp;longUrl=http://www.lg.com/es/posventa/microsites/lavado-secado/desactivar-sonido-teclas&amp;imageUrl=http://www.lg.com/es/mp-common/images/common/lg-logo-fb.png&amp;micrositeFlag=Y"
                ></div>
                <!-- LGEES-2535 END -->
              </div>
            </div>
                  ...
                  <div class="mpo-module" data-padding-top="10">
                    <div class="mpo-type-basic mpo-tb-nomedia">
                      <div class="mpo-desc-grp" mode="preview">
                        <div class="mpo-desc">
                          <p>
                            Es posible desactivar la melodía que reproduce la
                            lavadora o secadora cuando se inicia, se detiene o
                            se cambia la configuración.
                          </p>
                          <p> </p>
                          <p>
                            El procedimiento es muy sencillo pero diferente
                            dependiendo del tipo de panel. En la mayoría de
                            paneles aparece “*Avisos sonoros on/off”, en ese
                            caso, hay que presionar durante 3 segundos las
                            teclas indicadas.
                          </p>
                        </div>
                      </div>
					...
					<div class="mpo-module" data-padding-top="10">
					  <div class="mpo-type-basic bottom mpo-tb-image">
						<div class="mpo-media">
						  ...
						  >
							<img
							  alt="error-oe-manguera-desague"
							  src="/es/mp-resources/images/posventa/microsites/lavado-secado/desactivar-sonido-teclas/image1.png"
                  ...
                  <div class="mpo-module" data-padding-top="10">
                    <div class="mpo-type-basic mpo-tb-nomedia">
                      <div class="mpo-desc-grp" mode="preview">
                        <div class="mpo-desc">
                          <p>
                            A continuación, se muestran varios ejemplos de cómo
                            desactivar los avisos sonoros en lavadoras y
                            secadoras; si su equipo es diferente, por favor,
                            consulte el manual de usuario o contacte con soporte
                            técnico.
                          </p>
                          <p> </p>
                          <p>
                            Ejemplo 1: mantenga pulsados simultáneamente los
                            botones TurboWash y Pre-Lavado durante 3 segundos
                    ...
                    <div class="mpo-type-basic bottom mpo-tb-image">
                      <div class="mpo-media">
                        ...
                        >
                          <img
                            alt="error-oe-manguera-desague"
                            src="/es/mp-resources/images/posventa/microsites/lavado-secado/desactivar-sonido-teclas/image2.png"
                            class="img-fluid d-flex col-lg-5 col-6"
                          />
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="mpo-module" data-padding-top="10">
                    <div class="mpo-type-basic mpo-tb-nomedia">
                      <div class="mpo-desc-grp" mode="preview">
                        <div class="mpo-desc">
                          <p>
                            Ejemplo 2: mantenga pulsados simultáneamente los
                            botones Temperatura y Finalización diferida durante
                            3 segundos para activar/desactivar esta función.
                          </p>
                          <div
                            class="mpo-media span12 justify-content-center d-flex"
                          >
                            <img
                              alt="error-oe-manguera-desague"
                              src="/es/mp-resources/images/posventa/microsites/lavado-secado/desactivar-sonido-teclas/image3.png"
                              class="img-fluid d-flex col-lg-5 col-6"
                            />
                          </div>
                          <p>
                            NOTA: una vez establecida la función de activación/
                      ...
                      <div class="mpo-desc-grp" mode="preview">
                        <div class="mpo-desc">
                          <ul>
                            ...
                            <li>
                              <a
                                href="como-poner-programar-la-lavadora"
                                target="_parent"
                                >Cómo poner o programar la lavadora</a
                              >
                            </li>
                            <li>
                              <a
                                href="ruidos-vibraciones-golpes-durante-centrifugado"
                                target="_parent"
                                >Ruidos o zumbidos durante el lavado</a
                              >
                            </li>
                            <li>
                              <a
                                href="lavadora-no-utiliza-suavizante"
                                target="_parent"
                                >Lavadora no utiliza el suavizante</a
                              >
                            </li>
                            <li>
                              <a href="error-oe" target="_parent"
                                >Lavadora: error OE</a
                              >
                            </li>
                          </ul>
