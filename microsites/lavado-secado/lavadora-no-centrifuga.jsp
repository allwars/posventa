      ...
      <div class="wrapper">
        ...
        <div class="fluid container" id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col-12">
                El centrifugado es una operación necesaria para extraer el agua
                de las prendas. Si la lavadora no centrifuga, comprobar que no
                se ha deseleccionado el centrifugado; es necesario seleccionar
                una velocidad de centrifugado. Si se selecciona “No”; el
                programa no incluirá centrifugado.
              </div>
              <div class="col-12">
				
                <img
                  src="/es/mp-resources/images/posventa/microsites/lavado-secado/lavadora-no-centrifuga/image1.jpeg "
                  class="img-fluid w-50 mx-auto d-block col-6"
                  alt="..."
                />
              </div>
			  <div class="col-12">
				  <p>Las lavadoras LG incorporan un sensor que detecta la vibración; si no se consigue equilibrar la carga, la lavadora no centrifugará y es posible que muestre el error “uE” en pantalla.</p>
				  <p>Las razones por las que una lavadora puede no centrifugar son las siguientes:</p>
				  <ul>
					  <li style="list-style: inherit;" >Exceso de carga: si hay demasiada carga, por seguridad no centrifuga.</li>
					  <li style="list-style: inherit;" >Tamaño y peso de la carga diferentes: si, por ejemplo, se está lavando un edredón o un peluche con otras prendas, es posible que la lavadora no consiga equilibrar la carga y por seguridad no centrifugue.</li>
					  <li style="list-style: inherit;" >Producto desnivelado: revisar la siguiente <a href="https://www.lg.com/es/posventa/microsites/lavado-secado/ruidos-vibraciones-golpes-durante-centrifugado">web de ayuda</a>.</li>
				  </ul>
				  <p>Si el problema es la carga, pare la lavadora, espere a que se pueda abrir la puerta y retire prendas. Reanude el proceso de centrifugado.</p>
			  </div>
            </div>
          </div>
          <div class="row-wrap">
                ...
                <div class="mpo-desc-grp" mode="preview">
                  <div class="mpo-desc">
                    <ul>
                      ...
                      <li>
                        <a href="error-le-le1-e6" target="_parent"
                          >Errores AE, LE, LE1, E6</a
                        >
                      </li>
                      <li>
                        <a href="error-ie" target="_parent">Error IE</a>
                      </li>
                      <li>
                        <a href="error-oe" target="_parent">Error OE</a>
                      </li>
                      <li>
                        <a href="ruido-zumbido-lavadora-golpes" target="_parent"
                          >Ruidos o zumbidos</a
                        >
                      </li>
                    </ul>
