					...
					<div class="row mpo-header">
						<div class="span12">
							<div class="mpo-header-h1">
								...
								<h1>Códigos de Error secadoras</h1>
							</div>
					...
					<div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <p>El error Ant no es un error como tal. Es una notificación de que el programa ha terminado y la opción antiarrugas se ha seleccionado. Tan pronto como saque la ropa y se apague el aparato desaparecerá.</p>
                            </div>
                            </div>
                        <div class="row">
                            <div class="col">
                                <h2>Error bE – Error de correa</h2>
                                <p>El electrodoméstico ha registrado un fallo en la correa. Desenchufe el equipo, espere 60 segundos e inténtelo de nuevo. En caso de persistir,
                                    <a
                                        href="https://www.lg.com/cac/soporte/reparacion-garantia/solicitar-reparacion-sign-in">solicitar
                                        reparación</a> </p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <p>El electrodoméstico ha registrado un fallo en la resistencia. Desenchufe el equipo, espere 60 segundos e inténtelo de nuevo. En caso de persistir, <a
                                        href="https://www.lg.com/cac/soporte/reparacion-garantia/solicitar-reparacion-sign-in">solicitar
                                        reparación</a> </p>
                            </div>
                            <div class="col">
                                <h2>Error ELE – Error de fuga eléctrica</h2>
                                <p>El electrodoméstico ha registrado un fallo de sobrecarga de corriente. Desenchufe el equipo, espere 60 segundos e inténtelo de nuevo. En caso de persistir, <a
                                    href="https://www.lg.com/cac/soporte/reparacion-garantia/solicitar-reparacion-sign-in">solicitar
                                    reparación</a> </p>
                            </div>
                        </div>
