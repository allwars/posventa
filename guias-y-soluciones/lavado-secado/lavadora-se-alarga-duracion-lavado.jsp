					...
					<div class="container">
						<div class="row">
							<div class="col-12">
								...
								<img src="/es/mp-resources/images/posventa/guias-y-soluciones/lavado-secado/lavado-tarda-mas-de-lo-esperado/01.jpg"
                                            class="img-fluid w-50 mx-auto d-block col-6" alt="...">
								<img src="/es/mp-resources/images/posventa/guias-y-soluciones/lavado-secado/lavado-tarda-mas-de-lo-esperado/02.jpg"
                                            class="img-fluid w-50 mx-auto d-block col-6" alt="...">
								<div class="col-12">
								...
								<p>Para saber más sobre cargas y programas, consulte el <a href="http://www.lg.com/es/posventa/manuales-y-documentos"> Manual de usuario</a>.</p>
							</div>
						</div>
					</div>
