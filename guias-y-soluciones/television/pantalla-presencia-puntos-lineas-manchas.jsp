...
<head>
  ...
  <c:import
    ...
    charEncoding="utf-8"
  >
    <c:param name="title" value="presencia de puntos, líneas y manchas" />
          ...
          <div class="row mpo-header">
            <div class="span12">
              <div class="mpo-header-h1">
                <h1>Presencia de puntos, líneas y/o manchas en la pantall</h1>
              </div>
              ...
              <div class="row-fluid">
                <div class="span12 mpo-area flex-wrap">
                  <p>Estimado cliente,</p>  
                    ...
                    <p>A fin de poder prestarle el mejor soporte, necesitamos que nos facilite cierta información referente al estado de su televisor. Esta información está relacionada con la presencia de puntos de luz brillantes, líneas y/o manchas en la pantalla.</p>
                    

                    
                   <p>Por favor, acceda al <a href="https://bit.ly/3qPWmwG">siguiente link</a>, rellene el formulario y adjunte la siguiente información, que permitirá que la gestión de su solicitud sea más rápida y efectiva:  </p>
                    <ol>

                      <li>Indique si el efecto es visible en todos los canales y menús de su TV</li>
                      <li>Adjunte una foto de la factura de compra del producto. </li>
                      <li>Adjunte una foto del número de serie del televisor, que podrá encontrar en una etiqueta en la parte posterior de su televisor. </li>
                      <li>Adjunte una foto de la pantalla del televisor. Tenga en cuenta que debe poder verse toda la pantalla, sin etiquetas puestas encima. Es conveniente que sea una foto tomada con luz natural en la habitación. Tenga en cuenta que, al tomar la foto, lo ideal es que la imagen que se esté reproduciendo en la televisión sea una imagen de un canal de televisión, y no de un fondo de un color único.</li>
                    </ol>
                    
                    
                    <p>Tan pronto como se reciba esta información, uno de unos nuestros especialistas de producto lo revisará y contactará con usted para informarle de la solución más adecuada.</p>
