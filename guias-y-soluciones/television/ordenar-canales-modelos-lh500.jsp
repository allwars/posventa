...
<div class="mpo-desc">
<p>En esta guía te mostramos los pasos para ordenar los canales en los modelos <strong>32LH500D</strong> y <strong>43LH500T</strong>.</p>
<p> </p>
<p>En este ejemplo, vamos a mover un canal memorizado en la posición 8 a la número 7.</p>
<p> </p>
<p>Realiza el mismo procedimiento para ordenar el resto de canales.</p>
<p> </p>
<p><strong>NOTA</strong>: si tu modelo no te permite mover canales o no te aparece la opción azul al pulsar el botón <strong>LIST</strong>, descarga esta <a href="http://www.lg.com/es/posventa/descargas/32_43_LH500_V331.zip" style="text-align: center;" target="_parent">actualización (V3.31)</a> y <a href="actualizacion-software-modelos-lh500" target="_parent">sigue esta guía</a> para instalarla.</p>
</div>
</div>
</div>
</div>
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>1. Pulsa el botón <strong>LIST</strong> del mando a distancia para mostrar la lista de canales. Con las teclas de cursor (flechas) selecciona el canal que deseas mover, en nuestro ejemplo el 8. Ahora pulsa el botón <strong>AZUL (editar programa)</strong> del mando.</p>
</div>
</div>
<div class="mpo-media">
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>2. Introduce el nuevo número que quieres para el canal, en nuestro ejemplo el 7, y pulsa <strong>OK</strong>.</p>
<p> </p>
<p> </p>
</div>
</div>
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>3. El cambio de canales ya se ha efectuado, intercambiándose sus posiciones:</p>
</div>
</div>
<div class="mpo-media">
