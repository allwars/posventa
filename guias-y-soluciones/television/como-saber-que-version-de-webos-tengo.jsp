...
<div class="mpo-desc">
<p><strong>webOS</strong> es el sistema operativo más reciente de las Smart TV de LG que transforma el uso del televisor para hacerlo más intuitivo, rápido y divertido. Por todo ello, fue galardonado como el <strong>Mejor Smart TV de Europa por EISA</strong>.</p>
<p> </p>
<p>Navegar entre aplicaciones es muy rápido gracias a su premiado mando a distancia <a href="../../microsites/television/magic-control-modelos" target="_parent">Magic Control</a>. Cuando salgas de una aplicación, permanecerá abierta en segundo plano, para que accedas a ella de inmediato siempre que quieras, desde la barra inferior.</p>
<p> </p>
<p>Gracias a la tecnología <strong>webOS</strong>, los televisores LG SmartTV arrancan hasta un <strong>60%</strong> más rápido que otros y te ayudan a configurarlo todo en pocos pasos, casi sin darte cuenta, para tener los canales ordenados y la conexión a Internet preparada para disfrutar de horas de diversión.</p>
</div>
</div>
</div>
</div>
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>Conocer la versión del sistema <a href="http://www.lg.com/es/webos" target="_blank">webOS</a> de tu SmartTV es muy sencillo, en este apartado te damos unas sencillas claves para saber diferenciar y reconocer cada una. Pulsa en los siguientes desplegables:</p>
</div>
</div>
</div>
</div>
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>2. El launcher o menú smart que aparece al pulsar el botón Home (casa) presenta este aspecto:</p>
</div>
</div>
<div class="mpo-media">
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>1. Fíjate en el mando a distancia, si es el <a href="mando-magic-control-an-mr650-webos-2016" target="_parent">Magic Control AN-MR650</a>, los botones centrales tienen esta disposición:</p>
</div>
</div>
<div class="mpo-media">
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>1. Fíjate en el mando a distancia, si es el <a href="../../microsites/television/mando-magic-control-an-mr600-webos-2015" target="_parent">Magic Control AN-MR600</a>, los botones centrales tienen esta disposición:</p>
</div>
</div>
<div class="mpo-media">
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p><strong>NOTA:</strong> algunos modelos de TV 2014 recibieron una actualización de software que mejoró la interfaz de webOS haciéndola muy parecida al sistema 2.0 de los modelos 2015.</p>
</div>
</div>
</div>
</div>
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>1. Fíjate en el mando a distancia, si es el <a href="../../microsites/television/mando-magic-control-an-mr500-webos-2014" target="_parent">Magic Control</a>, los botones centrales tienen esta disposición:</p>
</div>
</div>
<div class="mpo-media">
