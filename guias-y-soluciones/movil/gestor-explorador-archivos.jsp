...
<!-- LGEES-2638 END-->
<!-- LGEES-2535 -->
<div class="shareload" data-url="/es/lgcompf4/support/share/snsList.lg?systemFlag=CS&amp;longUrl=http://www.lg.com/es/posventa/guias-y-soluciones/movil/gestor-explorador-archivos&amp;imageUrl=http://www.lg.com/es/mp-common/images/common/lg-logo-fb.png&amp;micrositeFlag=Y"></div>
<!-- LGEES-2535 END -->
</div>
</div>
</div>
...
<div class="mpo-desc">
<p>En esta guía vamos a ver cómo <strong>mover</strong> o <strong>copiar</strong> archivos (fotos, imágenes o vídeos) entre las diferentes memorias que puede tener un teléfono móvil o tablet:</p>
<p> </p>
<ul>
...
<p> </p>
<p>Es muy útil saber cómo mover archivos entre ambas memorias para, por ejemplo, liberar espacio de la memoria interna. Sigue los pasos del siguiente vídeo:</p>
</div>
</div>
</div>
</div>
...
<iframe allowfullscreen="" frameborder="0" height="100%" src="https://www.youtube.com/embed/sLVY-uuP77w?wmode=transparent" width="100%" wmode="opaque"></iframe>
</div>
</div>
<div class="mpo-module " data-padding-top="10">
<div class="mpo-type-basic mpo-tb-nomedia">
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p style="text-align: center;"><a href="https://www.youtube.com/watch?v=sLVY-uuP77w" target="_parent">Ver vídeo en Youtube</a></p>
</div>
</div>
</div>
</div>
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>Los pasos de esta guía no son válidos para esta serie de terminales:</p>
<p> </p>
<ul>
<li>LGX140</li>
<li>LGX150</li>
...
<p> </p>
<p>En estos casos, sigue las instrucciones de esta guía: <a href="gestor-explorador-archivos-modelos-lgx" target="_parent">Explorador de archivos en modelos LGX</a></p>
</div>
</div>
</div>
</div>
