...
<h1>G5 sensor de huellas</h1>
</div>
<div class="share" id="shareClick" style="margin-right:10px;">
<!-- LGEES-2638 START-->
<!-- LGEES-2638 END-->
<!-- LGEES-2535 -->
<div class="shareload" data-url="/es/lgcompf4/support/share/snsList.lg?systemFlag=CS&amp;longUrl=http://www.lg.com/es/posventa/guias-y-soluciones/movil/g5-lector-sensor-huella-dactilar&amp;imageUrl=http://www.lg.com/es/mp-common/images/common/lg-logo-fb.png&amp;micrositeFlag=Y"></div>
<!-- LGEES-2535 END -->
</div>
</div>
</div>
...
<div class="mpo-desc">
<p>El<strong> </strong><a href="http://www.lg.com/es/telefonos-moviles/lg-G5" target="_parent"><span class="mpo-lgred">LG G5</span></a><strong> </strong>integra un sensor de huellas dactilares en la parte trasera. Con él es muy sencillo, rápido y seguro desbloquear el terminal. Al mismo tiempo, también te servirá como medida de seguridad para acceder a aplicaciones, proteger contenido privado como fotos o mensajes y realizar pagos en internet de forma segura. Y por supuesto, también puedes desactivarlo, si ése es tu deseo.</p>
<p> </p>
<p>Toda la información que almacena el sensor de huellas <strong>localmente</strong> se encuentra <strong>encriptada</strong> y almacenada en un área de memoria no accesible por las aplicaciones. Tampoco se envía a Google o se comparte de alguna forma fuera del terminal. Si alguna vez extraviaras o perdieras el móvil, podrías borrar su contenido mediante el <a href="../../microsites/movil/bloqueo-robo-perdida" target="_parent">Administrador de Dispositivos de Google</a> (Android Device Manager).</p>
</div>
</div>
</div>
</div>
...
<span class="loader"><img alt="lg-g5-sensor-lector-huella-dactilar" src="/es/mp-resources/images/posventa/guias-y-soluciones/movil/g5-lector-sensor-huella-dactilar/lg-g5-sensor-lector-huella-dactilar_9999.jpg"/></span>
</div>
</div>
</div>
</div>
...
<div class="mpo-desc-grp" mode="preview">
<div class="mpo-desc">
<p>El sensor de huellas del <strong>LG G5</strong> cumple una doble función, a parte de leer tu huella, también funciona como un <strong>botón</strong>, que puedes presionar para bloquear/desbloquear la pantalla (pulsación corta) y encender/apagar el terminal (pulsación larga).</p>
<p> </p>
...
<li><a href="g5-conexion-cargador-usb-tipo-c" target="_parent">G5: conexión USB Tipo C</a></li>
