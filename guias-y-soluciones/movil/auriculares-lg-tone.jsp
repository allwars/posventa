...
<h1>AURICULARES BLUETOOTH LG TONE (FN4/FN6/FN7) – Aplicación “LG TONE FREE”</h1>
</div>
...
<div class="mpo-desc">
<p>A través de la aplicación <strong>“LG TONE Free”</strong> podrás conectar tus auriculares bluetooth <strong>LG TONE</strong> a tus dispositivos así como mantenerlos actualizados a la última versión de software entre otros.</p>
<p> </p>
<h2>VINCULAR LOS AURICULARES AL MÓVIL A TRAVÉS DE “LG TONE FREE”</h2>
<ul>
<li><strong>Descargar la aplicación</strong>: la aplicación está disponible tanto para Android como para iOS.
	<ul><li>Entrar en la aplicación “Play Store”/”App Store”, buscar <strong>“LG TONE Free”</strong> y descargar la aplicación.</li></ul>
...
<li>Una vez descargada la aplicación, se entrará en ella y se seguirán los pasos indicados para realizar la vinculación de los auriculares con el dispositivo móvil:</li>
	<div class="mpo-type-image mpo-media">
...
<li><strong>Conexión Automática</strong>: al abrir la base de carga y extraer uno de los auriculares, se mostrará un mensaje en la barra de notificaciones del terminal donde se deberá presionar sobre dicho mensaje.</li>
	<div class="mpo-type-image mpo-media">
...
<li><strong>Conexión Manual</strong>: para la conexión manual se deberá seguir la siguiente ruta en nuestro dispositivo móvil (*esto puede variar dependiendo del modelo y versión Android del equipo):</li>
...
<p>Si el equipo está <strong>conectado</strong>, aparecerá la siguiente imagen:</p>
<div class="mpo-type-image mpo-media">
...
<p>Si por el contrario le aparece la imagen siguiente, el dispositivo <strong>no se ha conectado</strong> y tendrá que repetir la búsqueda:</p>
<div class="mpo-type-image mpo-media">
...
<h2>ACTUALIZACIÓN DE SOFTWARE DE LG TONE</h2>
<p>Una vez descargada la aplicación y vinculados nuestros auriculares LG TONE a nuestro dispositivo móvil, para actualizarlos a la última versión se deberán seguir los siguientes pasos:</p>
<ul>
<li>Desplazarse hacia abajo en el menú principal de la aplicación hasta encontrar la opción <strong>“Actualización de software”</strong></li>
<div class="mpo-type-image mpo-media">
