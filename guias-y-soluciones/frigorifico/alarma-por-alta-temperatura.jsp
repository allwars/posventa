			...
			<div class="wrapper">
				...
				<div class="fluid container" id="content">
					...
					<div class="container">
						<div class="row">
							<div class="col-12">
								<p>La alarma de alta temperatura es una función que avisa cuando la temperatura del
									congelador aumenta lo suficiente como para resultar un problema. El LED de la
									pantalla de temperatura del congelador parpadea y la alarma suena.</p>
								<img src="/es/mp-resources//images/posventa/guias-y-soluciones/frigorifico/alarma-por-alta-temperatura/image1.jpeg"
									class="img-fluid w-50 mx-auto d-block" alt="...">
								<p>Esta alarma se enciende en los siguientes casos:</p>
								<ul>
									<li>
										Cuando el electrodoméstico se enciende por primera vez (por tanto, la
										temperatura del
										congelador es alta).
									</li>
									<li>
										Cuando la puerta del congelador lleva abierta bastante tiempo o se abre con
										mucha
										frecuencia.
									</li>
									<li>
									...
									<li>
										Cuando se colocan alimentos calientes en el congelador.
									</li>
								</ul>
								<p>¿Cómo se desactiva?</p>
								<p>Presione el botón “Freezer” hasta que la alarma deje de sonar. </p>
								<img src="/es/mp-resources//images/posventa/guias-y-soluciones/frigorifico/alarma-por-alta-temperatura/image2.png"
									class="img-fluid w-25 mx-auto d-block" alt="...">
								<p>Aquí tiene unas imágenes de los diferentes displays que puedes encontrar en los
									frigoríficos. Algunos modelos lo llevan externo, sobre la misma puerta del
									frigorífico, y otros interno…</p>
								<h3>Display Externo</h3>
								<img src="/es/mp-resources//images/posventa/guias-y-soluciones/frigorifico/alarma-por-alta-temperatura/image3.png"
									class="img-fluid w-50 mx-auto d-block" alt="...">
								<h3>Display Interno</h3>
								<img src="/es/mp-resources//images/posventa/guias-y-soluciones/frigorifico/alarma-por-alta-temperatura/image4.png"
									class="img-fluid w-50 mx-auto d-block" alt="...">
							</div>
						</div>
					</div>
